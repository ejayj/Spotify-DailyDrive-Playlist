...
#    """
#    mdb = getattr(g, "_database", None)#

#    if mdb is None:#

#        mdb = g._database = PyMongo(app).db
#       
#    return mdb
...
#mongo_client = MongoClient("mongodb://localhost:27017/")
#mdb = mongo_client.myDatabase.user
#todos = db.data
#print(mdb.insertOne({ "name": 'Jon Snow' }))
...
#print(mongo_client.db.user.find_one())

#mdb = mongo_client.mdb
